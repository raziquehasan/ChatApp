                ...
                <>
                    ...
                    <div className='mt-auto px-1 py-1 space-y-2'>
                        <div className='flex items-center space-x-2'>
                            <button 
                                onClick={() => navigate('/profile')} 
                                className='hover:bg-blue-600 w-10 h-10 cursor-pointer hover:text-white rounded-lg flex items-center justify-center transition-colors duration-200'
                            >
                                <FaUser size={20} />
                            </button>
                        ...
                        <div className='flex items-center space-x-2'>
                            <button 
                                ...
                                className='hover:bg-red-600 w-10 h-10 cursor-pointer hover:text-white rounded-lg flex items-center justify-center transition-colors duration-200'
                            >
                                <BiLogOut size={20} />
                            </button>
